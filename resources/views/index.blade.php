...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{ asset('images/LifeInUkSummitBradford_TheRootOfDavidMinistry.webp') }}" class="d-block w-100" alt="The Root of David Ministry">
      </div>
      <div class="carousel-item">
        <img src="{{ asset('images/home15.jpg') }}" class="d-block w-100" alt="The Root of David Ministry">
      </div>
      <div class="carousel-item">
        <img src="{{ asset('images/home16.jpg') }}" class="d-block w-100" alt="The Root of David Ministry">
      ...
      <div class="carousel-item">
        <img src="{{ asset('images/home05.jpg') }}" class="d-block w-100" alt="The Root of David Ministry">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="{{ asset('images/home08.jpg') }}" class="d-block w-100" alt="The Root of David Ministry">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="{{ asset('images/home09.jpg') }}" class="d-block w-100" alt="The Root of David Ministry">
        <div class="carousel-caption d-none d-md-block">
            <div class="wrap-caption div-slider">
                <h1 class="caption-heading bg">
