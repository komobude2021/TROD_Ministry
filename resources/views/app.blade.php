...
<body>
	...
	<nav class="navbar navbar-expand-sm  navbar-dark fixed-bottom d-xs-block d-sm-block d-md-none d-lg-none d-xl-none" style="background-color:#fff !important; box-shadow:0px 0px 1px #000; padding-top:10px; padding-bottom:10px; z-index: 99999;">
		<div class="container-fluid" style="text-align:center; line-height: 1; font-weight:bold">
			...
			<div class="col-sm-2 offset-md-1 kelly-nav">
				<a class="{{ (request()->is('/')) ? 'active-kel' : '' }}" href="{{ route('index') }}" >
            ...
            <div class="col-sm-2 kelly-nav">
				<a class="{{ (request()->is('live')) ? 'active-kel' : '' }}" href="{{ route('live') }}">
			...
			<div class="col-sm-2 kelly-nav">
				<a class="{{ (request()->is('sermon*')) ? 'active-kel' : '' }}" href="{{ route('sermon') }}">
			...
			<div class="col-sm-2 kelly-nav">
				<a class="{{ (request()->is('event')) ? 'active-kel' : '' }}" href="{{ route('event') }}">
			...
			<div class="col-sm-2 kelly-n">
				<span style="cursor:pointer" onclick="openNav()" class="{{ (request()->is('about') || (request()->is('volunteer*')) || (request()->is('gallery')) || (request()->is('contact')) ) ? 'active-kel' : '' }}">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-7 col-md-6">
                        <p>The Root of David - <strong>(TROD) Ministry</strong></p>
                    </div>
                        ...
                        <div class="footer-item">
                            ...
                            <div class="d-none d-md-block d-lg-block d-xl-block" style="padding-top: 20px">
                                <a href="https://play.google.com/store/apps/details?id=therootofdavid.trod" target="_new">
                                    <img src="{{ asset('images/googleplay.png') }}" style="width: 60%" />
                                </a>
                            </div>
                        </div>
                    </div>
	...
	<div id="mySidenav" class="sidenav">
		...
		<div style="text-align: left">
			<a href="{{ route('about') }}" class="{{ (request()->is('about')) ? 'sidenav-active' : '' }}">
				<i class="fa fa-info-circle"></i> About Us
			</a>

			<a href="{{ route('volunteer') }}" class="{{ (request()->is('volunteer*')) ? 'sidenav-active' : '' }}">
				<i class="fa fa-user"></i> Volunteer
			</a>

			<a href="{{ route('gallery') }}" class="{{ (request()->is('gallery')) ? 'sidenav-active' : '' }}">
				<i class="fa fa-picture-o"></i> Gallery
            </a>

			<a href="{{ route('contact') }}" class="{{ (request()->is('contact*')) ? 'sidenav-active' : '' }}">
