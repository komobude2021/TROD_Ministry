...
@section('content')
	...
	<div class="section">
		...
		<div class="content-wrap" style="background-image: url('{{ asset('images/worship_4.jpg') }}'); background-size: cover; padding-bottom: 25px">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="title">
		...
		@if ( $live[0]->next_event_date != null && (strtotime($live[0]->next_event_date) > time()) )
