                ...
                <div class="container-fluid" style=" background-color: #f0f0f0; padding-bottom: 20px; border-bottom-right-radius: 50% 20%;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5" style="padding: 0px">
                            <img src="{{ asset('images/volunteer.jpg') }}" style="border-bottom-right-radius: 80% 80%; width: 100%" />
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12" style="padding-bottom: 80px">
                    ...
                    <form name="form1" id="form1" action="{{ route('volunteersubmit') }}" method="POST" autocomplete="off">
                      @csrf
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 p-10">
                            ...
                            <input type="text" name="lastname" class="form-control" placeholder="Lastname" value="{{ old('lastname') }}" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" style="padding-top: 10px" >
                              <input type="text" name="address_line_1" class="form-control" placeholder="Address Line 1" value="{{ old('address_line_1') }}">
                            </div>
                            <div class="form-group col-md-6" style="padding-top: 10px">
                              <input type="text" name="address_line_2"  class="form-control" placeholder="Address Line 2" value="{{ old('address_line_2') }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-2 p-10">
                            <input type="text" name="post_code" class="form-control" placeholder="Postal/Zip Code" value="{{ old('post_code') }}">
                          </div>
                        </div>
