								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div style="padding-top: 5px">
											...
											<a href="<?php echo e(route('admin.sermonedit', [$sermon->id, $sermon->slug])); ?>">
												<i class="fa fa-pencil fa-kel video-links"></i>
											</a> &nbsp; &nbsp;

											<a href="<?php echo e($sermon->video_url); ?>" target="_new">
												<i class="fa fa-youtube-play fa-kel video-links"></i>
											</a> &nbsp; &nbsp;

											<form style="display: inline" method="POST" action="<?php echo e(route('admin.sermondelete', [$sermon->id, $sermon->slug])); ?>">
												<?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\TROD_Website_2\resources\views/admin/sermon.blade.php ENDPATH**/ ?>