        ...
        <div class="row">
            <div class="col-md-6 offset-md-3" style="margin-top: 250px;">
                ...
                <div>
                    ...
                    <form name="form1" id="form1" method="POST" action="<?php echo e(route('adminsubmit')); ?>" autocomplete="off">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\User\Desktop\TROD_Website_2\resources\views/admin.blade.php ENDPATH**/ ?>