...
<body>
	...
	<nav class="navbar navbar-expand-sm  navbar-dark fixed-bottom d-xs-block d-sm-block d-md-none d-lg-none d-xl-none" style="background-color:#fff !important; box-shadow:0px 0px 1px #000; padding-top:10px; padding-bottom:10px; z-index: 99999;">
		<div class="container-fluid" style="text-align:center; line-height: 1; font-weight:bold">
			...
			<div class="col-sm-2 kelly-nav">
				<a class="<?php echo e((request()->is('about')) ? 'active-kel' : ''); ?>" href="<?php echo e(route('about')); ?>">
					<i class="fa fa-info-circle" style="font-size: 28px"></i>
					<br/><span class="nav-f-11">About Us</span>
				</a>
			</div>
			...
			<div class="col-sm-2 kelly-n">
				<span style="cursor:pointer" onclick="openNav()" class="<?php echo e((request()->is('sermon*') || (request()->is('volunteer*')) || (request()->is('gallery')) || (request()->is('contact')) ) ? 'active-kel' : ''); ?>">
	...
	<div id="mySidenav" class="sidenav">
		...
		<div style="text-align: left">
			<a href="<?php echo e(route('sermon')); ?>" class="<?php echo e((request()->is('sermon*')) ? 'sidenav-active' : ''); ?>">
				<i class="fa fa-youtube-play"></i> Sermons
			</a>
...
</html><?php /**PATH C:\Users\User\Desktop\TROD Website\resources\views/app.blade.php ENDPATH**/ ?>